...
<head>
    ...
    function Del(username){
        ...
        if(window.confirm("Are you sure to delete " + username + "?")){
            ...
            location.href = "?c=UserList&a=delete&username=" + username;
        }
    }
    ...
    function Muti_Del(){
        if(window.confirm("Are you sure to delete all of the users you choose?")){
            ...
            location.href = "?c=UserList&a=delete";
        }
    }
    </script>
</head>
...
<body> 
    ...
    <div style="text-align:center; padding:auto;">
        ...
        <a href="?c=UserList&a=add">Add User</a>
        <p>Total:<font color=red><?php echo $records ?></font>users</p>
    </div>

    <form action="?c=UserList&a=delete" method="POST" align="center">
        <table width="800" border="1" align="center" rules="all" cellpadding="10" >
            ...
            <td><a href="?c=UserList&a=edit&id=<?php echo $arr['id']?>&username=<?php echo $arr['username']?>&email=<?php echo $arr['email']?>">edit</a></td>
